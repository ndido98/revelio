...
def test_file_name_formatting() -> None:
    with (
        ...
        mock_save.assert_has_calls(
            [
                mock.call(mock_nn.get_state_dict(), "model_0_10.0.pt"),
                mock.call(mock_nn.get_state_dict(), "model_1_5.0.pt"),
                mock.call(mock_nn.get_state_dict(), "model_2_15.0.pt"),
                mock.call(mock_nn.get_state_dict(), "model_3_12.5.pt"),
            ]
        )
